...
@property (nonatomic, copy) NSString *doneBtnTitleStr;//完成
@property (nonatomic, copy) NSString *cancelBtnTitleStr;//取消
@property (nonatomic, copy) NSString *previewBtnTitleStr;//预览
